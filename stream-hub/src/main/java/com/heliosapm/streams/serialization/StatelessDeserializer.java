...
/**
 * <p>Title: StatelessDeserializer</p>
 * <p>Description: TidyOop for deserializers with no state or config</p> 
 * <p>Company: Helios Development Group LLC</p>
 * @author Whitehead (nwhitehead AT heliosdev DOT org)
 * <p><code>com.heliosapm.streams.serialization.StatelessDeserializer</code></p>
 * @param <T> The type to be deserialized
 */

public abstract class StatelessDeserializer<T> implements Deserializer<T>{
