...
props.put("interceptor.classes", "com.heliosapm.streams.common.kafka.interceptor.MonitoringProducerInterceptor");

Producer<String, ByteBuf> producer = null;
try {
    producer = new KafkaProducer<String, ByteBuf>(props);
    ...
    if(producer!=null) try { producer.close(); } catch (x) {}
}
return null;