...
./bin/kafka-topics.sh --zookeeper $ZOOKEEP_URI --create --topic tsdb.metrics.binary --partitions 2 --replication-factor $REPL
# Accumulator topic. Metrics are counted infinitely and then written to tsdb.metrics.binary
./bin/kafka-topics.sh --zookeeper $ZOOKEEP_URI --create --topic tsdb.metrics.accumulator --partitions 2 --replication-factor $REPL
# Meter topic. Metrics are counted within a defined window to get a rate and then written to tsdb.metrics.binary
./bin/kafka-topics.sh --zookeeper $ZOOKEEP_URI --create --topic tsdb.metrics.meter --partitions 2 --replication-factor $REPL
...
./bin/kafka-topics.sh --zookeeper $ZOOKEEP_URI --create --topic tsdb.metrics.delta --partitions 2 --replication-factor $REPL
...
./bin/kafka-topics.sh --zookeeper $ZOOKEEP_URI --create --topic tsdb.metrics.pagg --partitions 2 --replication-factor $REPL
...
./bin/kafka-topics.sh --zookeeper $ZOOKEEP_URI --create --topic tsdb.metrics.psagg --partitions 2 --replication-factor $REPL
# Straight through topic. Metrics are written to tsdb.metrics.binary
./bin/kafka-topics.sh --zookeeper $ZOOKEEP_URI --create --topic tsdb.metrics.st --partitions 2 --replication-factor $REPL
# Metrics are examined to determine their type and then routed accordingly. Metrics are written to tsdb.metrics.binary
./bin/kafka-topics.sh --zookeeper $ZOOKEEP_URI --create --topic tsdb.metrics.directed --partitions 2 --replication-factor $REPL
