 ...
 * 
 */
package com.heliosapm.streams.metrichub.tsdbplugin.json;
...
import com.heliosapm.webrpc.jsonservice.JSONSubConfirm;
 ...
 */
public class Netty3JSONRequest {	
...
//	protected volatile JSONResponse response = null;
	 ...
	 */
	public static Netty3JSONRequest newJSONRequest(Channel channel, String tCode, long rid, long rerid, String serviceName, String opName, JsonNode request) {
		return new Netty3JSONRequest(channel, tCode, rid, rerid, serviceName, opName, request);
	}
	 ...
	 */
	public static Netty3JSONRequest newJSONRequest(Channel channel, CharSequence jsonContent) {
		...
		try {
			...
			return new Netty3JSONRequest(channel, 
	 ...
	 * @param request The original request
	 */
	protected Netty3JSONRequest(Channel channel, String tCode, long rid, long rerid, String serviceName, String opName, JsonNode request) {
	...
	public static void main(String[] args) {
		Netty3JSONRequest jr = Netty3JSONRequest.builder()
			.setOpName("foo")
	...
	/**
	 * Returns an error {@link Netty3JSONResponse} for this request
	 * @param message The error message to send
	 * @return an error {@link Netty3JSONResponse} for this request
	 */
	public Netty3JSONResponse error(CharSequence message) {
	 ...
	 * @return an error {@link Netty3JSONResponse} for this request
	 */
	public Netty3JSONResponse error(CharSequence message, Throwable t) {
		Netty3JSONResponse response = new Netty3JSONResponse(requestId, ResponseType.ERR, channel, this);
	...
	/**
	 * Returns a {@link Netty3JSONResponse} for this request
	 * @param responseType The response type of the response to prepare
	 * @return a {@link Netty3JSONResponse} for this request
	 */
	public Netty3JSONResponse response(final ResponseType responseType) {
		return new Netty3JSONResponse(requestId, responseType==null ? ResponseType.RESP : responseType, channel, this);
	}
...
//	}
	...
	protected static class Builder {
		 ...
		 * @return 
		 */
		public Netty3JSONRequest build() {
			return new Netty3JSONRequest(channel, tCode, rid, rerid, serviceName, opName, request);
		}
	 ...
	 * @return this request
	 */
	public Netty3JSONRequest removeFields(String...fieldNames) {
		if(fieldNames!=null) {
	 ...
	 * @return this request
	 */
	public Netty3JSONRequest allowDefaults(boolean allow) {
		allowDefaults = allow;
		return this;
	}
