...
under the License.
 */
package com.heliosapm.streams.agent.naming;
...
public class AgentName  extends NotificationBroadcasterSupport  implements AgentNameMBean {
  ...
  /** The JVM's PID */
	...
	/**
	 * {@inheritDoc}
	 * @see com.heliosapm.streams.agent.naming.AgentNameMBean#getAppNameSource()
	 */
	@Override
	...
	/**
	 * {@inheritDoc}
	 * @see com.heliosapm.streams.agent.naming.AgentNameMBean#getHostNameSource()
	 */
	@Override
...
//		log.info("Names reset: app:[{}], host:[{}]", newAppName, newHostName);
	...
	/**
	 * {@inheritDoc}
	 * @see com.heliosapm.streams.agent.naming.AgentNameMBean#resetAppName(java.lang.String)
	 */
	@Override
...
//			log.info("AppName reset: app:[{}]", newAppName);
	...
	/**
	 * {@inheritDoc}
	 * @see com.heliosapm.streams.agent.naming.AgentNameMBean#resetHostName(java.lang.String)
	 */
	@Override
