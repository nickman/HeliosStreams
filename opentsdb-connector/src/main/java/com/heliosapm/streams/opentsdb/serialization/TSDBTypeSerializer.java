 ...
 * <p><code>com.heliosapm.streams.opentsdb.serialization.TSDBTypeSerializer</code></p>
 */
...
public enum TSDBTypeSerializer {
	 ...
	 */
	public synchronized <T> void registerSerializer(final JsonSerializer<T> serializer) {
