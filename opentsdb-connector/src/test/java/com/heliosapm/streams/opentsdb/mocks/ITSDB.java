 ...
 * <p><code>com.heliosapm.streams.opentsdb.mocks.ITSDB</code></p>
 */
public interface ITSDB {
	 ...
	 * @throws TableNotFoundException if the hbase table is not installed
	 * @since 2.0
	 */
	public Deferred<ArrayList<Object>> checkNecessaryTablesExist();

	/** Number of cache hits during lookups involving UIDs. 
	 * @return the uid cache hits 
	 * */
	public int uidCacheHits();

	/** Number of cache misses during lookups involving UIDs. 
	 * @return the uid cache misses
	 * */
	 ...
	 * @return A list of the suggested metrics
	 */
	 ...
	 * @param search A prefix to search.
	 * @return A list of the suggested tag names
	 */
	 ...
	 * @param search A prefix to search.
	 * @return A list of the suggested tag values
	 */
	 ...
	 * @return The deferred boolean result
	 * @since 2.0
	 */
