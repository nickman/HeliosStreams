...
/**
 * <p>Title: StreamedMetricValueDeserializer</p>
 * <p>Description: </p> 
 * <p>Company: Helios Development Group LLC</p>
 * @author Whitehead (nwhitehead AT heliosdev DOT org)
 * <p><code>com.heliosapm.streams.metrics.StreamedMetricValueDeserializer</code></p>
 */

public class StreamedMetricValueDeserializer implements Deserializer<StreamedMetricValue> {
	 ...
	 */
	@Override
	public StreamedMetricValue deserialize(final String topic, final byte[] data) {
		return (StreamedMetricValue)StreamedMetric.read(data);
	}
