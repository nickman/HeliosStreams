...
/**
 * <p>Title: StreamedMetricValueSerializer</p>
 * <p>Description: Kafka serializer for {@link StreamedMetricValue} instances</p> 
 * <p>Company: Helios Development Group LLC</p>
 * @author Whitehead (nwhitehead AT heliosdev DOT org)
 * <p><code>com.heliosapm.streams.metrics.StreamedMetricValueSerializer</code></p>
 */

public class StreamedMetricValueSerializer implements Serializer<StreamedMetricValue> {
	 ...
	 */
	@Override
	public byte[] serialize(final String topic, final StreamedMetricValue data) {		
