...
import com.heliosapm.webrpc.NameUtil;
import com.heliosapm.webrpc.subpub.TSDBEvent;
import com.heliosapm.webrpc.subpub.TSDBEventType;
...
public class Datapoint {
	...
	public static final int DATAPOINT_BITMASK = TSDBEventType.getMask(
			TSDBEventType.DPOINT_DOUBLE, TSDBEventType.DPOINT_LONG);
	
	/**
	 * Creates a new Datapoint
	 * @param event The TSDBEvent to read the datapoint from 
	 */
	public Datapoint(final com.heliosapm.webrpc.subpub.TSDBEvent event) {
